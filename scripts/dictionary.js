  ...
  categories: {
    animals: [
      ...
      },
      {
        ...
        english: "Tiger",
        spanish: "Tigre",
        example: "A tiger has orange fur.",
      },
      {
        id: 7,
        english: "Rabbit",
      ...
      },
      {
        ...
        english: "Monkey",
        spanish: "Mono",
        example: "The monkey is swinging from the tree.",
      },
      {
        id: 11,
        english: "Bear",
        spanish: "Oso",
        example: "The bear is hibernating.",
      },
      {
        id: 12,
        english: "Giraffe",
      ...
      },
      {
        ...
        english: "Snake",
        spanish: "Serpiente",
        example: "The snake is slithering on the ground.",
      },
      {
        id: 14,
        english: "Wolf",
      ...
      },
      {
        ...
        english: "Kangaroo",
        spanish: "Canguro",
        example: "The kangaroo jumps very high.",
      },
    ],
    fruits: [
      {
      ...
      },
      {
        ...
        english: "Banana",
        spanish: "Plátano",
        example: "She loves eating bananas.",
      },
      {
        id: 3,
        english: "Grape",
      ...
      },
      {
        ...
        english: "Strawberry",
        spanish: "Fresa",
        example: "The strawberry is sweet and juicy.",
      },
      {
        id: 6,
        english: "Pineapple",
        spanish: "Piña",
        example: "The pineapple is very tropical.",
      },
      {
        id: 7,
        english: "Lemon",
        spanish: "Limón",
        example: "I use lemon to make lemonade.",
      },
      {
        id: 8,
        english: "Peach",
        spanish: "Durazno",
        example: "The peach is soft and fuzzy.",
      },
      {
        id: 9,
        english: "Watermelon",
      ...
      },
      {
        ...
        english: "Cherry",
        spanish: "Cereza",
        example: "Cherries are red and delicious.",
      },
      {
        id: 11,
        english: "Mango",
        spanish: "Mango",
        example: "I love eating mangoes when they're ripe.",
      },
      {
        id: 12,
        english: "Blueberry",
        spanish: "Arándano",
        example: "Blueberries are great in smoothies.",
      },
      {
        id: 13,
        english: "Plum",
        spanish: "Ciruela",
        example: "A plum is sweet and juicy.",
      },
      {
        id: 14,
        english: "Papaya",
        spanish: "Papaya",
        example: "Papaya is popular in tropical countries.",
      },
      {
        id: 15,
        english: "Avocado",
        spanish: "Aguacate",
        example: "I love making guacamole with avocado.",
      },
    ],
    colors: [
      ...
      },
      {
        ...
        english: "Brown",
        spanish: "Marrón",
        example: "The dog has a brown coat.",
      },
      {
        id: 11,
        english: "Gray",
      ...
      },
      {
        ...
        english: "Gold",
        spanish: "Oro",
        example: "She has a gold necklace.",
      },
      {
        id: 13,
        english: "Silver",
      ...
      },
      {
        ...
        english: "Beige",
        spanish: "Beige",
        example: "The walls are beige.",
      },
      {
        id: 15,
        english: "Turquoise",
        spanish: "Turquesa",
        example: "The sea is turquoise.",
      },
    ],
    ...
    skills: [
      {
        ...
        english: "Read",
        spanish: "Leer",
        example: "She can read very well.",
      },
      {
        id: 2,
        english: "Write",
      ...
      },
      {
        ...
        english: "Understand",
        spanish: "Entender",
        example: "She understands Spanish.",
      },
    ],
    verbs: [
      {
